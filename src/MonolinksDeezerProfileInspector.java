...
public class MonolinksDeezerProfileInspector extends ConsoleProgram {

    public void run(){
        monolinkDeezerConcertCrawler();
    }
    ...
    public void writeUserProfileData() {

        String dayDateFormat = createDateToday();

        File tourDatesData = new File( "monolinksProfileInspector " + dayDateFormat + ".txt");
        File tourData = new File("monolinksProfileInspector.txt");
        int count = 0;
        try {
    ...
    public void writeDataToLocalFile (String urlString){
        try {
            ...
            File tourDates = new File( "monolinksDeezerProfileInspector " + dayDateFormat + ".txt");
