...
public class GenTests extends ConsoleProgram {
    ...
    public void run(){
        ...
        String isSameImage = isTheSameGenImage(thisImage, genImage);
        println(isSameImage);
        String isSameImagePath = genHasSameImagePath(gen);
        String isSameClassImagePath = hasSameClassImagePath(gen);
        println(isSameClassImagePath);
        println(isSameImagePath);

        String genElement = gen.getElementName();
        String isTheSameGenElement = isTheSameGenElement(genElement);
        println(isTheSameGenElement);

        HashMap genQualities = gen.getElementQualities();
        String areTheSameGenQualities = areTheSameQualities(genQualities);
        println(areTheSameGenQualities);

        String genFamilyMember = gen.getFamilyMember();
        String isTheSameGenFamilyMember = isTheSameGenFamilyMember(genFamilyMember);
        println(isTheSameGenFamilyMember);

        HashMap genBodyPart = gen.getBodyPart();
        String isTheSameGenBodyPart = isTheSameBodyPart(genBodyPart);
        println(isTheSameGenBodyPart);

        String genAnimals = gen.getRelatedAnimal();
        String areTheSameAnimals = hasTheSameAnimals(genAnimals);
        println(areTheSameAnimals);

        HashMap divination = gen.getDivination();
        String isTheSameDivination =  isTheSameDivination(divination);
        println(isTheSameDivination);

        int number = gen.getNumber();
        String isTheSameNumber = isTheSameNumber(number);
