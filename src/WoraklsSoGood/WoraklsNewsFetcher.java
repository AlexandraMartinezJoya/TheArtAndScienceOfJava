...
public class WoraklsNewsFetcher extends ConsoleProgram{

    public void run(){
        String url = "https://www.google.com/search?q=worakls";
        crawler(url);
    }

    public void crawler(String startingUrl){
        ArrayList<String> listOfPendingUrls = new ArrayList<>();
        listOfPendingUrls.add("https://www.youtube.com/results?search_query=worakls");
    ...
    public ArrayList<String> getSubUrls (String urlString){
        ...
        try {
            ...
            File weatherToday = new File( "worakls " + dayDateFormat + ".html");
    ...
    public boolean isOrIsntOfficialWorakls(){
        return true;
    }
