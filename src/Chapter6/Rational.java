...
public class Rational {
    ...
    /**
     * Adds the rational numebr r to this one and returns the sum
     * @param r The rational number being added
     ...
     * @param r The rational number used as a multiplyer
     ...
     * @param r The rational number  as a divisor
    ...
    /**
     * Calculates the greatest common divider using Euclid's algorithm
     * @param x First integer
     * @param y Second integer
     * @return The common greatest divider of x and y
     */
