...
public class MonolinksEstySpreadSheet extends ConsoleProgram {

    public void run(){
        String url = "https://www.etsy.com/c/home-and-living";
        crawler(url);
    }

    public void crawler(String startingUrl){
        ArrayList<String> listOfPendingUrls = new ArrayList<>();
        listOfPendingUrls.add("https://www.etsy.com/c/home-and-living/home-decor/throw-pillows");
    ...
    public ArrayList<String> getSubUrls (String urlString){
        ...
        try {
            ...
            File weatherToday = new File( "monolinksEtsySpread " + dayDateFormat + ".html");
