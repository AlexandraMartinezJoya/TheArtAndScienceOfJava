...
public class KunTests extends ConsoleProgram{
    ...
    public String isKunClassPathImageSamePath(Kun kun) {
        String isTheSameClassImagePath = "The class image path is the same";
        String isNotTheSameClassImagePath = "The class image path is not the same";
        String expectedClassPath = "../IChingImages/UpToSixtyFour/1.Qian.jpg";
        if(kun.getImagePath().equals(expectedClassPath)) {
            return isTheSameClassImagePath;
        } else {
            return isNotTheSameClassImagePath;
        }
    }

    public String hasSameElement(String kunElementName, String expectedElementName) {
        String isExpectedElementNameTheSame = "Kun element name is same as expected and is" + kunElementName;
