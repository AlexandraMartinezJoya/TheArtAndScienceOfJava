...
public class YiIncrease extends IChingStone implements IChingLineNames {
    ...
    public YiIncrease(){
        imagePath = "../IChingImages/UpToSixtyFour/42.YiIncrease.jpg";
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Yi Increase";
        String keywords = "Benefit, Harvest, Enrichment, Generosity, Sharing your bounty, thunder carried by wind";
