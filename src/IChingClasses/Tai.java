...
public class Tai extends IChingStone implements IChingLineNames {
    ...
    public Tai() {
        imageClassPath = "../IChingImages/UpToSixtyFour/11.Tai.jpg";
        image = new GImage(imageClassPath);
        element = "Wind, Heaven";
        ...
        qualities.put("12", "Mutual consent");
        qualities.put("13", "Agreeable");
        qualities.put("14", "Bell");
    ...
    public String getImageClassPath() { return imageClassPath; }
