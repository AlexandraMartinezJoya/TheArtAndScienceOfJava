...
public class Kan extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText(){
        ...
        String title = "IChingClasses.Kan";
        String keywords = "Darkness, danger, despair, the abysimal, courage and devotion, maintaining faith, pushing through the rapids, getting through the other side";
