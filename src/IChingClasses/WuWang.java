...
public class WuWang extends IChingStone implements IChingLineNames {
    ...
    public WuWang () {
        imagePath = "../IChingImages/UpToSixtyFour/25.WuWang.jpg";
