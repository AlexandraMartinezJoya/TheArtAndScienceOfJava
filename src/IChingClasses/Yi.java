...
public class Yi extends IChingStone implements IChingLineNames {
    ...
    public Yi() {
        image = new GImage("IChingImages/IChingClasses.Yi.png");
        element = "Mountain, Thunder";
        qualities = new HashMap<String, String>();
        qualities.put("1", "Nurishment" );
        qualities.put("2", "Jaws");
        qualities.put("3", "Bluging cheeks");
        qualities.put("4", "Nourishing others");
        qualities.put("5", "Being nourished");
        qualities.put("6", "You are what you eat");
        number = 27;
    }
    ...
    private HashMap getDivinationText() {
        ...
        String theImage = " Heaven dwells in the center of the mountain: this is the image of Great Accumulation. Thus the superior person gathers knowledge of the words and deeds of the past, In order to strenthen his character and accumulate his virtue.";
