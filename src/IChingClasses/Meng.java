...
public class Meng extends IChingStone implements IChingLineNames {
    ...
    public Meng() {
        imagePath = "../IChingImages/UpToSixtyFour/4.Meng.jpg";
