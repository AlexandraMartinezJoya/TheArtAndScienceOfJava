...
public class DaXu  extends IChingStone implements IChingLineNames {
    ...
    public DaXu() {
        imagePath = "../IChingImages/UpToSixtyFour/26.DaXu.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String title = "DaXu - Great Accumulation";
        String keywords = "The taming power of the great, Great amassing, accumulation, great restraint, great care-taking, storing up, preparation, gathering knowledge, cultivating your abilities, improving yourself, waiting for the right moment";
