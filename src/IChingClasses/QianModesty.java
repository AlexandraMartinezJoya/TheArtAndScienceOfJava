...
public class QianModesty extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText() {
        ...
        String title = "IChingClasses.QianModesty";
        String keywords = "Humility, Modesty, Moderation, Temperance, Maintaining a balanced attitude, Fullfilling ones duties, Carrying things through to completion";
