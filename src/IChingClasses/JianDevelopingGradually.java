...
public class JianDevelopingGradually extends IChingStone implements IChingLineNames {
    ...
    public JianDevelopingGradually(){
        imagePath = "../IChingImages/UpToSixtyFour/53.JianDevelopingGradually.jpg";
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Jian Developing Gradually";
        String keywords = "Gradual advance, slow, steady development, Progress step by step, Faithfulness, persistence";
