...
public class GuiMei extends IChingStone implements IChingLineNames {
    ...
    public GuiMei() {
        image = new GImage("IChingImages/IChingClasses.GuiMei.png");
    ...
    private HashMap getDivinationText() {
        ...
        String keywords = "The Maiden given in marriage, Playing a subordinate role, subordonation, keeping in the background";
