...
public class Qian extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText() {
        ...
        String title = "IChingClasses.Qian-TheDynamic";
        String keywords = "Activity, Creativity, Dynamic force, Assertion, Strenght, Decisevness, Strong action, Going forward, Moving Upward, Undertaking something, Constant and ceasless extertion";
