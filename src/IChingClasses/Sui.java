...
public class Sui extends IChingStone implements IChingLineNames {
    ...
    public Sui() {
        imagePath = "../IChingImages/UpToSixtyFour/17.Sui.jpg";
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Sui - Following";
        String keywords = "Following, Allegiance, Loyalty, Looking out, Continuing, Adaptability, Being adaptable, Changing, Being able to distinguish and apply the changes needed";
