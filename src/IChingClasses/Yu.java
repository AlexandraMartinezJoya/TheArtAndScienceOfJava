...
public class Yu  extends IChingStone implements IChingLineNames {
    ...
    public Yu() {
        imagePath = "../IChingImages/UpToSixtyFour/16.Yu.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String title = "Yu - Enthusiasm";
        String keywords = "Stirring up, Inspiring, Broadcasting, Undertaking, Preparing for, planning ahead, enjoyment, delight";
        ...
        String theImage = "Thunder rises out of the earth, this is the image of enthusiasm, thus the kind of old made music, to rouse the spirits and inspire virtue, they offered it in splendor to worship the supreme diet, so that they might be worthy of their illustrious ancestors";
