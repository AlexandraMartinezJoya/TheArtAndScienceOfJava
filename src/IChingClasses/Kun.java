...
public class Kun extends IChingStone implements IChingLineNames {
    ...
    public Kun(){
        imagePath = "../IChingImages/UpToSixtyFour/2.Kun.jpg";
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Kun";
        String keywords = "Receptivity, Docility, Acquiescence , Acceptance, Adjustment, Nurturing";
        String theJudgement = "The Receptive, Supreme Success, It is Beneficial to be constant like a mare. If the superior person sets out to do something, he will go astray, but if he follows, he will find guidance. It is beneficial to find friends in the southwest and forego friends in the northeast. Serene perseverance brings good fortune.";
