...
public class Fu extends IChingStone implements IChingLineNames {
    ...
    public Fu() {
        imagePath = "../IChingImages/UpToSixtyFour/24.Fu.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String title = "Fu";
        String keywords = "Storm, Cloudy storms, Many thunders, Thunderstorm, Lightning speed, Lightning distance, Brainstorms, Brainstorms collaborating, Many ideas at the same time, turning point, restoration, renovation, renewal";
