...
public class DaZhuang  extends IChingStone implements IChingLineNames {
    ...
    public DaZhuang() {
        ...
        qualities.put("3", "Great Strenght");
        qualities.put("4", "Using your power wisely");
        qualities.put("5", "Uniting strenght with justice");
    ...
    private HashMap getDivinationText() {
        ...
        String keywords = "The power of the great, Dominance, Great Strenght, Using your power wisely, uniting strenght with justice";
