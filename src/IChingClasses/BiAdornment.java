...
public class BiAdornment extends IChingStone implements IChingLineNames {
    ...
    public BiAdornment() {
        image = new GImage("IChingImages/IChingClasses.BiAdornment.png");
        element = "Mountain, Fire";
        qualities = new HashMap<String, String>();
        qualities.put("1", "Inner fire" );
        qualities.put("2", "Strenght of character");
    ...
    private HashMap getDivinationText() {
        ...
        String keywords = "Grace, beauty, persuation, simplicity, inner beauty, inner focus, inner calm, inner smile";
