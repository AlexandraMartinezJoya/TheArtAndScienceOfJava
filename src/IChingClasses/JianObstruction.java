...
public class JianObstruction extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText() {
        ...
        String keywords = "Limping, stumbling, adversity, impediment, trouble, difficulty, hardship, hinderance, looking inward, self-reflection, surmounting the obstacles within";
