...
public class Bo extends IChingStone implements IChingLineNames {
    ...
    public Bo() {
        image = new GImage("IChingImages/IChingClasses.Bo.png");
        element = "IChingClasses.Gen, IChingClasses.Kun";
        qualities = new HashMap<String, String>();
        qualities.put("1", "Deterioration" );
        qualities.put("2", "Stripping away");
        qualities.put("3", "Collapse");
        qualities.put("4", "Falling appart");
    ...
    private HashMap getDivinationText() {
        ...
        String title = "IChingClasses.Bo - Splitting Apart";
