...
public class ZhongFu extends IChingStone implements IChingLineNames {
    ...
    public ZhongFu(){
        image = new GImage("../IChingImages/IChingClasses.ZhongFu.png");
        element = "Wind, Lake";
        ...
        qualities.put("9", "Self inner knowledge");
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Zhong IChingClasses.Fu - Inner truth";
        String keywords = "Windy Lake. Inner sincerity. Inner faithfulness, trustworthiness. Conformity between what is outside and inside. as within so outside, trusting your own instincts, being able to listen to yourself, self-inner knowledge";
        ...
        String theImage = "Wind over fire. This is the image of inner truth. Thus the superior person discusses criminal cases carefully, and postpones executions. Vine vantul ce iti ia cuvantul, Who by truth";
