...
public class Jing extends IChingStone implements IChingLineNames {
    ...
    public Jing() {
        imagePath = "../IChingImages/UpToSixtyFour/48.Jing.jpg";
