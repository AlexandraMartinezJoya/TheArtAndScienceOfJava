...
public class Feng extends IChingStone implements IChingLineNames {
    ...
    public Feng() {
        imagePath = "../IChingImages/UpToSixtyFour/55.Feng.jpg";
        image = new GImage(imagePath);
        element = "Thunder, Fire";
        qualities = new HashMap<String, String>();
        qualities.put("1", "Abundance" );
    ...
    private HashMap getDivinationText() {
        ...
        String theImage = "Thunder and lightning culminate as one, This is the image of abundance, thus the superior person judges cases, and carries out punishments.";
