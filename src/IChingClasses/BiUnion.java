...
public class BiUnion extends IChingStone implements IChingLineNames {
    ...
    public BiUnion() {
        imagePath ="../IChingImages/UpToSixtyFour/8.BiUnion.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String keywords = "Union. Good fortune. Look deep down inside yourself and divine. Whether you have greatness, perseverance, and constancy, for there will be no blame, those who lack peace gradually come from all sides. Those who arrive too late meet with misfortune.";
        String theJudgement = "Obstruction. The southwest is beneficial. The northeast is not. It is beneficial to see a great person. Perseverance brings good fortune.";
