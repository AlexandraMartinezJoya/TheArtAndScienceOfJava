...
public class KuiOpposition extends IChingStone implements IChingLineNames {
    ...
    public KuiOpposition() {
        imagePath = "../IChingImages/UpToSixtyFour/38.KuiOpposition.jpg";
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Kui Opposition";
        String keywords = "Estrangement, Misunderstanding, Different points of view, Polarity, Diversity, Creative tension, Finding commonality within difference";
