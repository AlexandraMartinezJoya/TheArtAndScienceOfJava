...
public class Heng extends IChingStone implements IChingLineNames {
    ...
    public Heng() {
        imagePath = "../IChingImages/UpToSixtyFour/32.Heng.jpg";
