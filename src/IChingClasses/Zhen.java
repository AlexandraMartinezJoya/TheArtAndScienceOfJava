...
public class Zhen extends IChingStone implements IChingLineNames {
    ...
    public Zhen(){
        imagePath = "../IChingImages/UpToSixtyFour/51.Zhen.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String title = "Zhen";
        String keywords = "Thunder, Shake, Quake, Upheaval,The arousing, Reassess your life, Shocking you out of your lethargy, Hidden potential in sudden change,Blessing in disguise, Taking action";
        String theJudgement = "Shock. Success,Thunder comes - crack, crack! Afterward there is laughter and talk - ha, ha! The shock terrifies for a hundred miles, but he does not let the sacrificial spoon and chalice fail.";
