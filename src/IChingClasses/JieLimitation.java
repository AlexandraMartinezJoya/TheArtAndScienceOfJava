...
public class JieLimitation extends IChingStone implements IChingLineNames {
    ...
    public JieLimitation() {
        imagePath = "../IChingImages/UpToSixtyFour/60.JieLimitation.jpg";
