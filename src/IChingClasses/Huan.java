...
public class Huan extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText(){
        ...
        String title = "Huan Dispersion ";
        String keywords = "Dispersion. Dissolution. Getting rid of egotism. Bringing people together. Finding a comon purpose, Clearing up blockages, Melting the ice, Eliminating obstacles within yourself";
