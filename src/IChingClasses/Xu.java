...
public class Xu extends IChingStone implements IChingLineNames {
    ...
    private HashMap getDivinationText() {
        ...
        String title = "IChingClasses.Xu - Calculated waiting";
        String keywords = "Calculated waiting, biding your time, waiting for rain, nurishment, replenishment";
