...
public class Pi  extends IChingStone implements IChingLineNames {
    ...
    public Pi () {
        imagePath = "../IChingImages/UpToSixtyFour/12.Pi.jpg";
    ...
    private HashMap getDivinationText() {
        ...
        String title = "Pi-Standstill";
        String keywords = "Stagnation, blockage, misfortune, disharmony, hindrance";
