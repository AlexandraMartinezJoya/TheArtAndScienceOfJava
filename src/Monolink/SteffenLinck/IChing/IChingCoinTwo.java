...
public class IChingCoinTwo extends GraphicsProgram implements IChingCoinModel {
    ...
    public Monolink.SteffenLinck.IChing.IChingCoinTypes coinType;
    ...
    public GImage create() {
        ...
        if(number == 1) {
            coinType =  Monolink.SteffenLinck.IChing.IChingCoinTypes.COIN_DIFFERENT_HEADS;
            return new GImage("Shell.jpg");
        }
        else{
            coinType = Monolink.SteffenLinck.IChing.IChingCoinTypes.COIN_DIFFERENT_TAILS;
