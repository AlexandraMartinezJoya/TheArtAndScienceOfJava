...
public class IChingCoinOne extends GraphicsProgram implements IChingCoinModel {
    ...
    private Monolink.SteffenLinck.IChing.IChingCoinTypes coinType;
    ...
    public GImage create() {
        ...
        if(number == 1) {
            coinType = Monolink.SteffenLinck.IChing.IChingCoinTypes.HEADS;
            return new GImage("CoinFaceOne.png");
        }
       else{
            coinType = Monolink.SteffenLinck.IChing.IChingCoinTypes.TAILS;
