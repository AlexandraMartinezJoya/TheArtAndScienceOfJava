...
public class IChingCoinTwo extends GraphicsProgram implements IChingCoinModel {
    ...
    public Worakls.KevinRodriguez.IChing.IChingCoinTypes coinType;
    ...
    public GImage create() {
        ...
        if(number == 1) {
            coinType =  Worakls.KevinRodriguez.IChing.IChingCoinTypes.COIN_DIFFERENT_HEADS;
            return new GImage("Shell.jpg");
        }
        else{
            coinType = Worakls.KevinRodriguez.IChing.IChingCoinTypes.COIN_DIFFERENT_TAILS;
