...
public class IChingCoinOne extends GraphicsProgram implements IChingCoinModel {
    ...
    private Worakls.KevinRodriguez.IChing.IChingCoinTypes coinType;
    ...
    public GImage create() {
        ...
        if(number == 1) {
            coinType = Worakls.KevinRodriguez.IChing.IChingCoinTypes.HEADS;
            return new GImage("CoinFaceOne.png");
        }
       else{
            coinType = Worakls.KevinRodriguez.IChing.IChingCoinTypes.TAILS;
