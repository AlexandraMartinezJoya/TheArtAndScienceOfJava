...
public class DrawHeartMap extends GraphicsProgram {
    ...
    public void mouseClicked(MouseEvent e) {
        GHeart heart = new GHeart(getCurrentSize());
        heart.setFilled(filledCheckbox.isSelected());
        heart.setFillColor(getCurrentColor());
        add(heart, e.getX() - getCurrentSize(), e.getY() + getCurrentSize() * 2);
    }
