...
public class FoundFrequenciesAtAGivenTime extends ConsoleProgram {
    ...
    public void run(){
        String url = "https://www.google.com/search?q=lost+frequencies";
        crawler(url);
    }

    public void crawler(String startingUrl){
        ArrayList<String> listOfPendingUrls = new ArrayList<>();
        listOfPendingUrls.add("https://open.spotify.com/playlist/73L47cwLjkliuWVl7upc16");
    ...
    public ArrayList<String> getSubUrls (String urlString){
        ...
        try {
            ...
            File foundfrequencies = new File( "foundFrequenciesSpotify " + dayDateFormat + ".html");
            PrintWriter output = new PrintWriter(foundfrequencies);
            while(input.hasNext()) {
